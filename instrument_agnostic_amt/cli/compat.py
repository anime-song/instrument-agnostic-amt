"""Legacy CLI helpers shared by repository and installed-package workflows."""
...
def _load_model_and_settings(
    ...
    *,
    ...
    model, config, checkpoint_args = load_model(Path(checkpoint_path), device=device)
    ...
    settings = resolve_inference_settings(config, checkpoint_args, args)
