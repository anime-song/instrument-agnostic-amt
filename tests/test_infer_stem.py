...
def test_stem_pipeline_velocity_ignores_a_missing_stem_during_preload(
    ...
    def remove_other_before_velocity(**_kwargs: object) -> tuple[object, object, object]:
        pipeline.stems["other"].unlink()
        return object(), object(), velocity_config

    monkeypatch.setattr(infer_stem, "get_velocity_models", remove_other_before_velocity)
